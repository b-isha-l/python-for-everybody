...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_603406.txt (There are 103 values and the sum ends with 966)
...
fhand = open(fname)
for lines in fhand:
    integer = re.findall("[0-9]+", lines) # finding for integers
    for num in integer:
        numb = int(num) # converting string into integer
        snum += numb
print(snum)